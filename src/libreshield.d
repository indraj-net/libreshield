...
enum PQCPublicKeyBytes = 32;
enum PQCPrivateKeyBytes = 64;
enum PQCSignatureBytes = 7856;
...
ubyte[] clientHandshake(ref Session session)
{
        ...
        ulong sigLength;
        rc = OQS_SIG_sphincs_shake_128s_simple_sign(
                                        PQCSignature.ptr,
                                        &sigLength,
                                        toServer.ptr,
                                        toServer.length,
...
ubyte[] serverHandshake(ref Session session, ubyte[] hello)
{
        ...
        if (OQS_SIG_sphincs_shake_128s_simple_verify(
                                        message.ptr,
                                        message.length,
...
void generateIdentity(ref JSONValue identity, ref JSONValue cert)
{
        ...
        OQS_STATUS rc = OQS_SIG_sphincs_shake_128s_simple_keypair(
