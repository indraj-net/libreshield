...
OQS_STATUS OQS_SIG_sphincs_shake_128s_simple_keypair(uint8_t *public_key,
                                                     uint8_t *secret_key);

OQS_STATUS OQS_KEM_ml_kem_768_keypair(uint8_t *public_key, uint8_t *secret_key);

OQS_STATUS OQS_SIG_sphincs_shake_128s_simple_sign(uint8_t *signature,
                                                  size_t *signature_len,
                                                  const uint8_t *message,
                                                  size_t message_len,
                                                  const uint8_t *secret_key);

OQS_STATUS OQS_SIG_sphincs_shake_128s_simple_verify(const uint8_t *message,
                                                    size_t message_len,
